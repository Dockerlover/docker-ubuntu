...
RUN apt-get update && apt-get install -y supervisor build-essential ca-certificates openssh-server
# 可选安装包
RUN apt-get install -y uzip git-core vim curl  && rm -rf /var/lib/apt/lists/*
